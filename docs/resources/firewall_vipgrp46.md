...
* `name` - VIP46 name. This attribute must reference one of the following datasources: `firewall.vip46.name` .
...
fortios_firewall_vipgrp46 can be imported using:
```sh
terraform import fortios_firewall_vipgrp46.labelname {{mkey}}
```
