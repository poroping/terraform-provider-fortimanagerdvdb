...
description: |-
  Get information on a fortios Filters for null device logging.
---

# Data Source: fortios_lognulldevice_filter
Use this data source to get information on a fortios Filters for null device logging.
