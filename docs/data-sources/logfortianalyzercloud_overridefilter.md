...
description: |-
  Get information on a fortios Override filters for FortiAnalyzer Cloud.
---

# Data Source: fortios_logfortianalyzercloud_overridefilter
Use this data source to get information on a fortios Override filters for FortiAnalyzer Cloud.
