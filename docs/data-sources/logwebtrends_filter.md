...
description: |-
  Get information on a fortios Filters for WebTrends.
---

# Data Source: fortios_logwebtrends_filter
Use this data source to get information on a fortios Filters for WebTrends.
