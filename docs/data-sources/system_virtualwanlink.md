...
description: |-
  Get information on a fortios Configure redundant internet connections using SD-WAN (formerly virtual WAN link).
---

# Data Source: fortios_system_virtualwanlink
Use this data source to get information on a fortios Configure redundant internet connections using SD-WAN (formerly virtual WAN link).
