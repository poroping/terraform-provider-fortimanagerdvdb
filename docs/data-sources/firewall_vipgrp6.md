...
description: |-
  Get information on a fortios Configure IPv6 virtual IP groups.
---

# Data Source: fortios_firewall_vipgrp6
Use this data source to get information on a fortios Configure IPv6 virtual IP groups.
